...
ggsave("mapa_neo_tot.png", plot = mapa_neo_tot, width = 10, height = 6, dpi = 800)
...
ggsave("mapa_neo_uti.png", plot = mapa_neo_uti, width = 10, height = 6, dpi = 800)
